...
CREATE TABLE IF NOT EXISTS `BEGANSS`.`PROFESS` (
  `PROFESS_ID` INT NOT NULL AUTO_INCREMENT,
  `FIRST_NAME` VARCHAR(10) NOT NULL,
  `SECOND_NAME` VARCHAR(20) NOT NULL,
  `AVG_MARK` DECIMAL(4,3) NOT NULL,
  PRIMARY KEY (`PROFESS_ID`),
  UNIQUE INDEX `PROFESS_ID_UNIQUE` (`PROFESS_ID` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `BEGANSS`.`STUDENT` (
  ...
  `SECOND_NAME` VARCHAR(20) NOT NULL,
  `AVG_MARK` DECIMAL(4,3) NOT NULL,
  `GROUP_NUMBER` VARCHAR(3) NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `BEGANSS`.`MARK` (
  ...
  UNIQUE INDEX `MARK_ID_UNIQUE` (`MARK_ID` ASC),
...
-- Table `BEGANSS`.`USER`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `BEGANSS`.`USER` (
